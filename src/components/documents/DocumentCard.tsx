...
import { getFileTypeInfo, getPlaceholderThumbnail, formatFileSize } from '../../utils/fileTypes';
        ...
        <CardContent className="flex items-center gap-4 p-4">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2">
              ...
              {accessStatus.type !== 'active' && accessStatus.type !== 'unrestricted' && (
                <Badge variant={accessStatus.type === 'expired' ? 'destructive' : 'secondary'} className="text-xs">
                  {accessStatus.type === 'expired' ? <Lock className="w-3 h-3 mr-1" /> : <Clock className="w-3 h-3 mr-1" />}
  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[4/3] bg-muted flex items-center justify-center overflow-hidden">
        ...
        {(accessStatus.type === 'expired' || accessStatus.type === 'not-started') && (
          <div className="absolute inset-0 bg-background/80 backdrop-blur-sm flex items-center justify-center">
            <Badge variant={accessStatus.type === 'expired' ? 'destructive' : 'secondary'} className="text-sm">
        ...
        <div className="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity">
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem onClick={handleAction(() => onDownload(document))}>
